...
// por qué cafes queda como un objeto y no como un array?
...
app.get('/cafes', (req, res) => res.status(200).send(cafes))
...
app.all('*', (req, res) => res.status(404).send({ message: 'La ruta que intenta consultar no existe' }))
